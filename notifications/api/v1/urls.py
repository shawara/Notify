...
urlpatterns = [
    path('messages/', views.MessageViewSet.as_view(list_create)),
    path('messages/<int:pk>/', views.MessageViewSet.as_view(retrieve_update_delete)),
    path('customers/', views.CustomerViewSet.as_view(list_create)),
    ...
    path('notifications/', views.NotificationViewSet.as_view(list_create)),
